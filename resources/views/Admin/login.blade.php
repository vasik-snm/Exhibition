							...
							<div class="card-body">
								<div class="p-4">
									<div class="mb-3 text-center">
                                        {{-- C:\xampp\htdocs\crystal_ceramic\public\images\crystalline ceramic.png --}}
										<img src="{{ asset('images/Exhibitions.png') }}" width="160px" alt="Exhibition Image" />
									</div>
									<div class="text-center mb-4">
										<h5 class="">Exhibition Admin</h5>
