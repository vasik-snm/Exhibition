...
<head>
	...
	<!--favicon-->
	<link rel="icon" href="{{ url('images/crystalline ceramic.png') }}" type="image/png"/>
	<!--plugins-->
	...
	<div class="wrapper">
		...
		<div class="sidebar-wrapper" data-simplebar="true">
			<div class="sidebar-header">
				<div>
					{{-- <img src="{{ url('images/crystalline ceramic.png') }}" class="logo-icon" alt="logo icon"> --}}
				</div>
				<div>
					<h4 class="logo-text" style="font-size: 20px">Exhibition</h4>
				</div>
			...
			<ul class="metismenu" id="menu">
                ...
                <li>
                    <a href="{{ url('/stall_list') }}" >
                        <div class="parent-icon"><i class="fa-solid fa-user"></i>
                        </div>
                        <div class="menu-title">Stall List</div>
                    </a>
                </li>

                {{-- <li>
                    <a href="{{ url('/order_list') }}" >
                        <div class="parent-icon"><i class="fa-solid fa-arrow-up-z-a"></i>
                        </div>
                ...
                {{-- <li>
                    <a href="{{ url('/offer_list') }}" >
                        ...
                        <div class="menu-title">Offer Details</div>
                    </a>
                </li> --}}

                {{-- <li>
                    <a href="{{ url('/achievement_list') }}" >
                        <div class="parent-icon"><i class="fa-solid fa-trophy"></i>
                        </div>
                        <div class="menu-title">Achievement</div>
                    </a>
                </li> --}}

                {{-- <li>
                    <a href="{{ url('/clientPurchase_productsList') }}" >
                        <div class="parent-icon"><i class="fa-solid fa-clipboard"></i>
                        </div>
                        <div class="menu-title">Client Records</div>
                    </a>
                </li> --}}

                {{-- <li>
                    <a href="{{ url('/product_purchase_list') }}" >
                        <div class="parent-icon"><i class="fa-regular fa-clipboard"></i>
                        </div>
                        <div class="menu-title">Product Records</div>
                    </a>
                </li> --}}

                {{-- <li>
                    <a href="{{ url('/offerDetails_list') }}" >
                        <div class="parent-icon">
                        </div>
                        <div class="menu-title">Offer List</div>
                    </a>
                </li> --}}
                    ...
                    {{-- <ul>
                        <li>
                            <a href="#" class="has-arrow">
                                <i class="fa-solid fa-brush"></i> Colour Details
                            </a>
                            <ul class="submenu">
                                <li><a href="{{ url('/create_colour') }}"><i class="fa-solid fa-arrow-right"></i>Add Colour</a></li>
                                <li><a href="{{ url('/colour_list') }}"><i class="fa-solid fa-arrow-right"></i>Colour List</a></li>
                            </ul>
                        </li>
                        <li>
                            <a href="#" class="has-arrow">
                                <i class="fa-brands fa-mixer"></i> Variant Details
                            </a>
                            <ul class="submenu">
                                <li><a href="{{ url('/create_variant') }}"><i class="fa-solid fa-arrow-right"></i>Add Variant</a></li>
                                <li><a href="{{ url('/variant_list') }}"><i class="fa-solid fa-arrow-right"></i>Variant List</a></li>
                            </ul>
                        </li>
                    </ul> --}}
                        ...
                        {{-- <ul>
                            <li>
                                <a href="#" class="has-arrow">
                                    <i class="fa-solid fa-house-circle-check"></i> Banner Details
                                </a>
                                <ul class="submenu">
                                    <li><a href="{{ url('/create_banner') }}"><i class="fa-solid fa-arrow-right"></i> Add Banner</a></li>
                                    <li><a href="{{ url('/banner_list') }}"><i class="fa-solid fa-arrow-right"></i> Banner List</a></li>
                                </ul>
                            </li>
                        </ul> --}}
                        ...
                        {{-- <ul>
                            <li>
                                <a href="#" class="has-arrow">
                                    <i class="fa-solid fa-table-list"></i> Category Details
                                </a>
                                <ul class="submenu">
                                    <li><a href="{{ url('/create_category') }}"><i class="fa-solid fa-arrow-right"></i> Add Category</a></li>
                                    <li><a href="{{ url('/category_list') }}"><i class="fa-solid fa-arrow-right"></i> Category List</a></li>
                                </ul>
                            </li>
                        </ul> --}}
                        ...
                        {{-- <ul>
                            <li>
                                <a href="#" class="has-arrow">
                                    <i class="fa-brands fa-font-awesome"></i></i> Brand Details
                                </a>
                                <ul class="submenu">
                                    <li><a href="{{ url('/create_brand') }}"><i class="fa-solid fa-arrow-right"></i> Add Brand</a></li>
                                    <li><a href="{{ url('/brand_list') }}"><i class="fa-solid fa-arrow-right"></i> Brand List</a></li>
                                </ul>
                            </li>
                        </ul> --}}
                        ...
                        {{-- <ul>
                            <li>
                                <a href="#" class="has-arrow">
                                    <i class="fa-brands fa-stack-exchange"></i></i> Brand Categories Details
                                </a>
                                <ul class="submenu">
                                    <li><a href="{{ url('/create_brandCategories') }}"><i class="fa-solid fa-arrow-right"></i> Add Brand Categories</a></li>
                                    <li><a href="{{ url('/brandCategories_list') }}"><i class="fa-solid fa-arrow-right"></i> Brand Categories List</a></li>
                                </ul>
                            </li>
                        </ul> --}}
                        ...
                        {{-- <ul>
                            <li>
                                <a href="#" class="has-arrow">
                                    <i class="fa-solid fa-code"></i></i>Standard Code
                                </a>
                                <ul class="submenu">
                                    <li><a href="{{ url('/create_starndardCode') }}"><i class="fa-solid fa-arrow-right"></i> Add Standard Code</a></li>
                                    <li><a href="{{ url('/standardCode_list') }}"><i class="fa-solid fa-arrow-right"></i> Standard Code List</a></li>
                                </ul>
                            </li>
                        </ul> --}}
                        ...
                        {{-- <ul>
                            <li>
                                <a href="#" class="has-arrow">
                                    <i class="fa-brands fa-product-hunt"></i></i> Product Details
                                </a>
                                <ul class="submenu">
                                    <li><a href="{{ url('/create_product') }}"><i class="fa-solid fa-arrow-right"></i> Add Product</a></li>
                                    <li><a href="{{ url('/product_list') }}"><i class="fa-solid fa-arrow-right"></i> Product List</a></li>
                                </ul>
                            </li>
                        </ul> --}}
                        {{-- <li>
                            <a href="#" class="has-arrow">
                                <i class='fas fa-money-check'></i> Payment History
                            </a>
                            <ul class="submenu">
                                <li><a href="{{ url('/create_payment') }}"><i class="fa-solid fa-arrow-right"></i>Add Payment</a></li>
                                <li><a href="{{ url('/payment_list') }}"><i class="fa-solid fa-arrow-right"></i>Payment List</a></li>
                            </ul>
                        </li> --}}

					{{-- <ul>
						<li> <a href="#" class="has-arrow">
                            <i class='bx bx-radio-circle'></i>Client Details</a>
                        	<ul>
                                <li> <a href="{{ url('/client_create') }}"><i class="fa-solid fa-arrow-right"></i>Add Client</a></li>
                                <li> <a href="{{ url('/client_list') }}"><i class="fa-solid fa-arrow-right"></i>Client List</a></li>
                            </ul>
                        </li>
                        <li> <a href="#" class="has-arrow">
                            <i class='bx bx-radio-circle'></i>Product Details</a>
                        	<ul>
                                <li> <a href="{{ url('/product_create') }}"><i class="fa-solid fa-arrow-right"></i></i>Add Product</a></li>
                                <li> <a href="{{ url('/product_list') }}"><i class="fa-solid fa-arrow-right"></i></i>Product List</a></li>
                            </ul>
                        </li>
                        <li> <a href="#" class="has-arrow">
                            <i class='bx bx-radio-circle'></i>Invoice Details</a>
                        	<ul>
                                <li> <a href="{{ url('/product_create') }}"><i class="fa-solid fa-arrow-right"></i></i>Add Invoice</a></li>
                                <li> <a href="{{ url('/product_list') }}"><i class="fa-solid fa-arrow-right"></i></i>Product Invoice</a></li>
                            </ul>
                        </li>
                    </ul> --}}

						{{-- <li> <a href="{{ url('/product_create') }}"><i class='bx bx-radio-circle'></i>Product Details</a></li>
                        <li> <a href="{{ url('/home_service') }}"><i class='bx bx-radio-circle'></i>Service</a></li>
                        <li> <a href="{{ url('/home_blog') }}"><i class='bx bx-radio-circle'></i>Blog</a></li>
                        <li> <a href="{{ url('/home_contact') }}"><i class='bx bx-radio-circle'></i>Enquiry</a></li>
                        <li> <a href="{{ url('/home_footer') }}"><i class='bx bx-radio-circle'></i>Footer</a></li>
                    </ul>
			...
			<div class="topbar d-flex align-items-center">
				<nav class="navbar navbar-expand gap-3">
									  ...
									  <div class="row gx-0 gy-2 row-cols-3 justify-content-center p-2">
										 <div class="col">
										  <a href="javascript:;">
											<div class="app-box text-center">
											  <div class="app-icon">
												  <img src="{{ url('admin_assets/assets/images/app/slack.png') }}" width="30" alt="">
											  </div>
											  <div class="app-name">
										 ...
										 <div class="col">
										  <a href="javascript:;">
											<div class="app-box text-center">
											  <div class="app-icon">
												  <img src="{{ url('admin_assets/assets/images/app/behance.png') }}" width="30" alt="">
											  </div>
											  <div class="app-name">
										 ...
										 <div class="col">
										  <a href="javascript:;">
											<div class="app-box text-center">
											  <div class="app-icon">
												<img src="{{ url('admin_assets/assets/images/app/google-drive.png') }}" width="30" alt="">
											  </div>
											  <div class="app-name">
										 ...
										 <div class="col">
										  <a href="javascript:;">
											<div class="app-box text-center">
											  <div class="app-icon">
												  <img src="{{ url('admin_assets/assets/images/app/outlook.png') }}" width="30" alt="">
											  </div>
											  <div class="app-name">
										 ...
										 <div class="col">
										  <a href="javascript:;">
											<div class="app-box text-center">
											  <div class="app-icon">
												  <img src="{{ url('admin_assets/assets/images/app/github.png') }}" width="30" alt="">
											  </div>
											  <div class="app-name">
										 ...
										 <div class="col">
										  <a href="javascript:;">
											<div class="app-box text-center">
											  <div class="app-icon">
												  <img src="{{ url('admin_assets/assets/images/app/stack-overflow.png') }}" width="30" alt="">
											  </div>
											  <div class="app-name">
										 ...
										 <div class="col">
										  <a href="javascript:;">
											<div class="app-box text-center">
											  <div class="app-icon">
												  <img src="{{ url('admin_assets/assets/images/app/figma.png') }}" width="30" alt="">
											  </div>
											  <div class="app-name">
												  <p class="mb-0 mt-1">Stack</p>
											  </div>
										 ...
										 <div class="col">
										  <a href="javascript:;">
											<div class="app-box text-center">
											  <div class="app-icon">
												  <img src="{{ url('admin_assets/assets/images/app/twitter.png') }}" width="30" alt="">
											  </div>
											  <div class="app-name">
										 ...
										 <div class="col">
										  <a href="javascript:;">
											<div class="app-box text-center">
											  <div class="app-icon">
												  <img src="{{ url('admin_assets/assets/images/app/google-calendar.png') }}" width="30" alt="">
											  </div>
											  <div class="app-name">
										 ...
										 <div class="col">
										  <a href="javascript:;">
											<div class="app-box text-center">
											  <div class="app-icon">
												  <img src="{{ url('admin_assets/assets/images/app/spotify.png') }}" width="30" alt="">
											  </div>
											  <div class="app-name">
										 ...
										 <div class="col">
										  <a href="javascript:;">
											<div class="app-box text-center">
											  <div class="app-icon">
												  <img src="{{ url('admin_assets/assets/images/app/google-photos.png') }}" width="30" alt="">
											  </div>
											  <div class="app-name">
										 ...
										 <div class="col">
										  <a href="javascript:;">
											<div class="app-box text-center">
											  <div class="app-icon">
												  <img src="{{ url('admin_assets/assets/images/app/pinterest.png') }}" width="30" alt="">
											  </div>
											  <div class="app-name">
												  <p class="mb-0 mt-1">Photos</p>
											  </div>
										 ...
										 <div class="col">
										  <a href="javascript:;">
											<div class="app-box text-center">
											  <div class="app-icon">
												  <img src="{{ url('admin_assets/assets/images/app/linkedin.png') }}" width="30" alt="">
											  </div>
											  <div class="app-name">
										 ...
										 <div class="col">
										  <a href="javascript:;">
											<div class="app-box text-center">
											  <div class="app-icon">
												  <img src="{{ url('admin_assets/assets/images/app/dribble.png') }}" width="30" alt="">
											  </div>
											  <div class="app-name">
												  <p class="mb-0 mt-1">Dribble</p>
											  </div>
										 ...
										 <div class="col">
										  <a href="javascript:;">
											<div class="app-box text-center">
											  <div class="app-icon">
												  <img src="{{ url('admin_assets/assets/images/app/youtube.png') }}" width="30" alt="">
											  </div>
											  <div class="app-name">
										 ...
										 <div class="col">
										  <a href="javascript:;">
											<div class="app-box text-center">
											  <div class="app-icon">
												  <img src="{{ url('admin_assets/assets/images/app/google.png') }}" width="30" alt="">
											  </div>
											  <div class="app-name">
										 ...
										 <div class="col">
										  <a href="javascript:;">
											<div class="app-box text-center">
											  <div class="app-icon">
												  <img src="{{ url('admin_assets/assets/images/app/envato.png') }}" width="30" alt="">
											  </div>
											  <div class="app-name">
										 ...
										 <div class="col">
										  <a href="javascript:;">
											<div class="app-box text-center">
											  <div class="app-icon">
												  <img src="{{ url('admin_assets/assets/images/app/safari.png') }}" width="30" alt="">
											  </div>
											  <div class="app-name">
								...
								<div class="dropdown-menu dropdown-menu-end">
									...
									<div class="header-notifications-list">
										<a class="dropdown-item" href="javascript:;">
											<div class="d-flex align-items-center">
												<div class="user-online">
													<img src="{{ url('admin_assets/assets/images/avatars/avatar-1.png') }}" class="msg-avatar" alt="user avatar">
												</div>
										...
										<a class="dropdown-item" href="javascript:;">
											<div class="d-flex align-items-center">
												<div class="user-online">
													<img src="{{ url('admin_assets/assets/images/avatars/avatar-2.png') }}" class="msg-avatar" alt="user avatar">
												</div>
												<div class="flex-grow-1">
										...
										<a class="dropdown-item" href="javascript:;">
											<div class="d-flex align-items-center">
												<div class="notify bg-light-success text-success">
													<img src="{{ url('admin_assets/assets/images/app/outlook.png') }}" width="25" alt="user avatar">
												</div>
												<div class="flex-grow-1">
										...
										<a class="dropdown-item" href="javascript:;">
											<div class="d-flex align-items-center">
												<div class="user-online">
													<img src="{{ url('admin_assets/assets/images/avatars/avatar-4.png') }}" class="msg-avatar" alt="user avatar">
												</div>
												<div class="flex-grow-1">
										...
										<a class="dropdown-item" href="javascript:;">
											<div class="d-flex align-items-center">
												<div class="notify bg-light-primary">
													<img src="{{ url('admin_assets/assets/images/app/github.png') }}" width="25" alt="user avatar">
												</div>
												<div class="flex-grow-1">
										...
										<a class="dropdown-item" href="javascript:;">
											<div class="d-flex align-items-center">
												<div class="user-online">
													<img src="{{ url('admin_assets/assets/images/avatars/avatar-8.png') }}" class="msg-avatar" alt="user avatar">
												</div>
												<div class="flex-grow-1">
									...
									<div class="header-message-list">
											...
											<div class="d-flex align-items-center gap-3">
												<div class="position-relative">
													<div class="cart-product rounded-circle bg-light">
														<img src="{{ url('admin_assets/assets/images/products/11.png') }}" class="" alt="product image">
													</div>
												</div>
												<div class="flex-grow-1">
										...
										<a class="dropdown-item" href="javascript:;">
											<div class="d-flex align-items-center gap-3">
												<div class="position-relative">
													<div class="cart-product rounded-circle bg-light">
														<img src="{{ url('admin_assets/assets/images/products/02.png') }}" class="" alt="product image">
													</div>
												</div>
												<div class="flex-grow-1">
													<h6 class="cart-product-title mb-0">Men White T-Shirt</h6>
										...
										<a class="dropdown-item" href="javascript:;">
											<div class="d-flex align-items-center gap-3">
												<div class="position-relative">
													<div class="cart-product rounded-circle bg-light">
														<img src="{{ url('admin_assets/assets/images/products/03.png') }}" class="" alt="product image">
													</div>
												</div>
												<div class="flex-grow-1">
													<h6 class="cart-product-title mb-0">Men White T-Shirt</h6>
										...
										<a class="dropdown-item" href="javascript:;">
											<div class="d-flex align-items-center gap-3">
												<div class="position-relative">
													<div class="cart-product rounded-circle bg-light">
														<img src="{{ url('admin_assets/assets/images/products/04.png') }}" class="" alt="product image">
													</div>
												</div>
												<div class="flex-grow-1">
													<h6 class="cart-product-title mb-0">Men White T-Shirt</h6>
										...
										<a class="dropdown-item" href="javascript:;">
											<div class="d-flex align-items-center gap-3">
												<div class="position-relative">
													<div class="cart-product rounded-circle bg-light">
														<img src="{{ url('admin_assets/assets/images/products/05.png') }}" class="" alt="product image">
													</div>
												</div>
												<div class="flex-grow-1">
													<h6 class="cart-product-title mb-0">Men White T-Shirt</h6>
										...
										<a class="dropdown-item" href="javascript:;">
											<div class="d-flex align-items-center gap-3">
												<div class="position-relative">
													<div class="cart-product rounded-circle bg-light">
														<img src="{{ url('admin_assets/assets/images/products/06.png') }}" class="" alt="product image">
													</div>
												</div>
												<div class="flex-grow-1">
													<h6 class="cart-product-title mb-0">Men White T-Shirt</h6>
										...
										<a class="dropdown-item" href="javascript:;">
											<div class="d-flex align-items-center gap-3">
												<div class="position-relative">
													<div class="cart-product rounded-circle bg-light">
														<img src="{{ url('admin_assets/assets/images/products/07.png') }}" class="" alt="product image">
													</div>
												</div>
												<div class="flex-grow-1">
													<h6 class="cart-product-title mb-0">Men White T-Shirt</h6>
										...
										<a class="dropdown-item" href="javascript:;">
											<div class="d-flex align-items-center gap-3">
												<div class="position-relative">
													<div class="cart-product rounded-circle bg-light">
														<img src="{{ url('admin_assets/assets/images/products/08.png') }}" class="" alt="product image">
													</div>
												</div>
												<div class="flex-grow-1">
													<h6 class="cart-product-title mb-0">Men White T-Shirt</h6>
										...
										<a class="dropdown-item" href="javascript:;">
											<div class="d-flex align-items-center gap-3">
												<div class="position-relative">
													<div class="cart-product rounded-circle bg-light">
														<img src="{{ url('images/profile_pic.png') }}" class="" alt="product image">
													</div>
												</div>
												<div class="flex-grow-1">
													<h6 class="cart-product-title mb-0">Men White T-Shirt</h6>
					...
					<div class="user-box dropdown px-3">
                        ...
                        {{-- <img src="{{ url('images/profile_pic.png') }}" class="user-img" alt="User details"> --}}
						...
						<ul class="dropdown-menu dropdown-menu-end">
                            <li>
                                <a class="dropdown-item d-flex align-items-center" href="{{ route('admin.profile', ['id' => Auth::guard('admin')->id()]) }}">
							...
							<li>
								{{-- <a class="dropdown-item d-flex align-items-center" href="{{ url('admin_password_change') }}"><i class="bx bx-cog fs-5"></i><span>Settings</span></a> --}}
							</li>
							...
							<li><a class="dropdown-item d-flex align-items-center" href="{{ url('/logout_admin') }}"><i class="bx bx-log-out-circle"></i><span>Logout</span></a>
							</li> --}}
                            <li>
                                <div class="dropdown-divider mb-0"></div>
                            </li>
